...
// kandelrob@gmail.com								||
// 													||
// created 01.28.15	| updated 01.29.15				||
// philly_locations.js								||
// version 0.0.1									||
////////////////////////////////////////////////////||
        ...
        backbone: {
            ...
            location_id: function(id) {
            	...
            	jQuery.ajax({
            		...
            		error: function(d) {
            			if (_flag) {
            				method.backbone.location_id(id)
            			}
            			_flag = false;
            		}  
            	});
            ...
            view_helper : {
                ...
                status_class: function(a) {
                	...
                	b = a.toLowerCase();
                	switch(true) {
                		case b == 'completed': return 'success'; break;
                		case b == 'complied': return 'warning'; break;
                		case b == 'active': return 'active'; break;
                		case b == 'expired': return 'warning'; break;
                		case b == 'not complied': return 'danger'; break;
                	}
                	return 'active'
                }
            }
